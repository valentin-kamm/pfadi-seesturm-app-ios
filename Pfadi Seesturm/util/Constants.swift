...
struct Constants {
    ...
    static let ONBOARDING_SCREEN_VERSION: Int = 2
    ...
    static let SCHOPFLIALARM_MIN_PAUSE: Double = 3600 //s = 1h
    ...
    static var WORDPRESS_API_BASE_URL = "https://seesturm.ch/wp-json/seesturmAppCustomEndpoints/v2/"
