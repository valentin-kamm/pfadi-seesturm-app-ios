...
class WordpressService {
    ...
    func fetchFromWordpress<T, R>(
        ...
        do {
            ...
            case .messagingPermissionError(_), .unknownStufe(_), .unknownNotificationTopic(_), .unknownAktivitaetInteraction(_), .authError(_), .cancelled(_), .unknown(_), .unknownSchoepflialarmReactionType(_), .jpgConversionFailed(_):
